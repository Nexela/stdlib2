...
--- @return number
--- @deprecated Use math.round
function math.round_to(num, num_decimals)
...
--- @param num_decimals number
--- @return number
--- @deprecated Use math.ceiled
function math.ceil_to(num, num_decimals)
    local mult = 10 ^ num_decimals
...
--- @param num_decimals number
--- @return number
--- @deprecated use math.floored
function math.floor_to(num, num_decimals)
    local mult = 10 ^ num_decimals
